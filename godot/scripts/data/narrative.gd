...
## Story content for the game. Originally ported from index.html; the current
## wording is authored in the external "Tower Text Studio" tool and applied here.
##
...
const PATRONS := [
	{
		...
		"lore": [
			...
			"More deeply, Dee believed the universe itself was encoded, that behind the apparent randomness of the cards lay a divine mathematical order. He was one of the first to suspect that the Sacred Shuffle is a source of immense power."
		]
	},
	{
		"id": "marie",
...
const LORE := [
	{
		...
		"bio": [
			...
			"Unlike the Time Patrons, who guard the secret out of caution and respect, the Cult wants it for domination. They do not seek to understand Solitaire, they seek to exploit it."
		],
		...
		"strategy": [
			...
			"Their current plan is brutally simple: seize a building, an office tower, a building full of office workers, and force its occupants to play Solitaire continuously, around the clock. By the sheer law of large numbers, the Sacred Shuffle will eventually appear on one of the screens."
		]
	}
]
...
const DEE_DIALOGUE := [
	...
	{
		"speaker": "scene",
		"text": "You catch a glimpse of a face.",
		"img": "res://assets/intro/intro_face_glimpse.jpg"
	},
	{
		"speaker": "scene",
		"text": "It takes a moment to realize it's yours.",
	...
	{
		"speaker": "scene",
		"text": "You feel like you're waking up from a long nightmare... into something worse.\n\nStartled, you ask yourself…"
	},
	{
		"speaker": "you",
		"choices": [
	...
	},
	{
		"speaker": "dee",
		"scene": true,
		"text": "It's a bearded man with a look straight out of an 17th century painting."
	},
	{
		"speaker": "you",
		"choices": [
	...
	{
		"speaker": "dee",
		"text": "A peculiar phrasing, but hell indeed! Hear me now, and hear me well. I wish I had a calmer way to say this, but I do not: the fate of human civilization hangs in the balance."
	},
	{
		"speaker": "dee",
		"text": "The Cult of Patience has seized the counting-house where you work, through means I won’t dignify to qualify as magic. They have been making you play Solitaire repeatedly, endlessly. Has it been days? Weeks? Months? I am not sure myself."
	},
	{
		"speaker": "you",
		"choices": [
	...
	{
		"speaker": "you",
		"text": "But what does all this have to do with me?"
	},
	{
		"speaker": "dee",
		"text": "Only you can stop them."
	},
	{
		"speaker": "you",
		"text": "Huh, OK? How?"
	...
	{
		"speaker": "dee",
		"text": "We will talk more later. Now, you must play or the Cult will notice you and kill you!"
	},
	{
		"speaker": "dee",
		"text": "Play Solitaire or die!"
	}
]

const VICTORY_LINES := [
	"You have shown why you were chosen by the Sacred Shuffle. I am afraid, though, this journey is only beginning.",
	"Our victory over the Cult of Doom will only be complete when all Time Patrons are revealed."
]
...
const DEE_CHECKIN_TOPICS := [
	...
	},
	{
		...
		"beats": [
			{
				"speaker": "dee",
				"text": "I have been studying the history and variants of the game you call Solitaire since my years spent in Rudolf II’s court in Prague, the center of Kabbalistic scholarship."
			},
			{
				"speaker": "dee",
			...
			{
				"speaker": "dee",
				"text": "As I came to understand the power of a deck of cards, I managed to establish connections through time with other souls who became aware of the existence of the Sacred Shuffle, and shared my concern about the Cult of Doom."
			},
			{
				"speaker": "you",
	...
	{
		"id": "role",
		"question": "What is my role in all this?",
		"beats": [
			{
				"speaker": "dee",
			...
			{
				"speaker": "you",
				"text": "Were you the Queen's official punster?"
			},
			{
				"speaker": "dee",
				"text": "The Cult does not know that the Sacred Shuffle does not choose a screen. It chooses a player. They do not know you have been chosen. They cannot know. You have to keep playing and beat a shuffle on every floor."
			},
			{
				"speaker": "you",
...
const DEE_DIALOGUE3_TOPICS := [
	...
	},
	{
		...
		"beats": [
			...
			{
				"speaker": "dee",
				"text": "Your memory is starting to leak through time. Even if you think this is the first time we’re having this conversation, it could be the millionth time."
			},
			{
				"speaker": "you",
	...
	},
	{
		...
		"beats": [
			...
			{
				"speaker": "dee",
				"text": "You need to generate Time Energy, but also you need to weave the threads of time, find the connections between the Time Patrons. Even I do not know their all their identities. There is one from my time..."
			},
			{
				"speaker": "you",
				"text": "Who?"
