...
const MAP := {
	...
	"CREDITS": "CRÉDITS",
	"Options": "Options",
	"Game Design, Art & Writing": "Conception, art et écriture",
	"aka Emjayhar": "alias Emjayhar",
	"AI tools were used to assist with the game's source code.": "Des outils d’IA ont contribué au code source du jeu.",
	"Music": "Musique",
	"Made With": "Réalisé avec",
	"Fonts": "Polices",
	"Licensed under the SIL Open Font License": "Sous licence SIL Open Font License",
	"All rights reserved.": "Tous droits réservés.",
	"Solitaire Tower of Doom™ is a trademark of Mario Jorge Ramos.": "Solitaire Tower of Doom™ est une marque de Mario Jorge Ramos.",
	"Back": "Retour",
	"Back ▸": "Retour ▸",
	"◂ Back": "◂ Retour",
	"Done": "Terminé",
	...
	"Lives": "Vies",
	"🏆 HIGH SCORES": "🏆 MEILLEURS SCORES",
	"Time Patron": "Mécène Temporel",
	"Time Credits": "Crédits Temporels",
	"Time Energy": "Énergie Temporelle",
	...
	"⚑ New Run": "⚑ Nouvelle descente",
	"HIGH SCORES ": "MEILLEURS SCORES ",
	"🏆 High Scores": "🏆 Meilleurs scores",
	"New Run": "Nouvelle descente",
	"Start a New Run?\n\nThis ends your current descent — the rest of your lives are forfeit and your run is scored now.": "Commencer une nouvelle descente ?\n\nCeci met fin à votre descente en cours — vos vies restantes sont perdues et votre partie est comptabilisée maintenant.",
	...
	"⏳  Floor %d Cleared — Time Credits Awarded": "⏳  Étage %d réussi — Crédits Temporels accordés",
	"🏪  John Dee's Cabinet of Curiosities — %d Items Available": "🏪 Le Cabinet de curiosités de John Dee — %d objets disponibles",
	...
	"Instant: pops 10 undo states.": "Instantané : annule 10 mouvements d'un coup.",
	...
	"All games (boss skip!)": "Tous les jeux (sauter le boss !)",
	...
	"No run in progress": "Aucune descente en cours",
	"— Empty —": "— Vide —",
	"⚡ %d   ✓ %d": "⚡ %d   ✓ %d",
	...
	# ══════════════════════════════════════════════════════════════════════════
	"⚡ Time Energy: %d": "⚡ Énergie Temporel : %d",
	...
	"Mary, Queen of Scots": "Mary, reine d’Écosse",
	...
	"The Cult of Patience": "Le Culte de la Patience",
	...
	#  Dialogue — victory
	# ══════════════════════════════════════════════════════════════════════════
	"You have shown why you were chosen by the Sacred Shuffle. I am afraid, though, this journey is only beginning.": "Vous avez montré pourquoi l'Arrangement Sacré vous a choisi. Je crains toutefois que ce périple ne fasse que commencer.",
	"Our victory over the Cult of Doom will only be complete when all Time Patrons are revealed.": "Notre victoire sur le Culte de la Perdition ne sera complète que lorsque tous les Mécènes Temporels seront révélés.",
	...
	"Why do they want the Sacred Shuffle?": "Pourquoi veulent-ils l'Arrangement Sacré ?",
	"Why are you involved in all this?": "Pourquoi êtes-vous mêlé à tout ceci ?",
	"What is my role in all this?": "Quel est mon rôle dans tout ça ?",
	"They call themselves the Cult of Patience. I call them the Cult of Doom.": "Ils se nomment le Culte de la Patience. Moi, je les appelle le Culte de la Perdition.",
	...
	"They have been trying to play the Sacred Shuffle for centuries. In the shadows.": "Ils tentent de jouer l'Arrangement Sacré depuis des siècles. Dans l’ombre.",
	"What’s different now?": "Qu’est-ce qui a changé, aujourd’hui ?",
	"The Digital Age.": "L’ère numérique.",
	"A single game of cards, dealt and shuffled by hand, takes no small measure of time to set in order and play to its end. With these machines of your time, hundreds, thousands shuffles can be generated and played in mere seconds.": "Une seule partie de cartes, distribuée et brassée à la main, exige un temps non négligeable pour être mise en ordre et menée à terme. Avec les machines de votre époque, des centaines, des milliers d'arrangements peuvent être générés et joués en quelques secondes.",
	"Who’s behind the masks?": "Qui se cache derrière les masques ?",
	"Nobility rejects, revolution survivors, ex-political prisoners. People who fell from high, in terms of their position in society. Their obsessive need for wealth, power and stature has twisted their minds beyond recognition.": "Des rejets de la noblesse, des survivants de révolutions, d’anciens prisonniers politiques. Des gens tombés de haut, quant à leur rang dans la société. Leur besoin obsessionnel de richesse, de pouvoir et de prestige a tordu leur esprit au point de le rendre méconnaissable.",
	"They have extended their lives with dangerous dark arts. The longer they live, the less human they become. Only the obsession remains.": "Ils ont prolongé leur vie par de la dangereuse magie noire. Plus ils vivent longtemps, moins ils sont humains. Seule l’obsession demeure.",
	...
	"Time and change are their enemies. They believe the Sacred Shuffle can take them back to a time where they were at the height of their power, and keep them there, forever.": "Le temps et le changement sont leurs ennemis. Ils croient que l'Arrangement Sacré peut les ramener à une époque où ils étaient au sommet de leur puissance, et les y maintenir, à jamais.",
	"They want to make everything great again, huh.": "Ils veulent que tout redevienne « great again », hein.",
	...
	"You are destined to play the Sacred Shuffle.": "Vous êtes destiné à jouer l'Arrangement Sacré.",
	...
	"Ha.": "Ha.",
	"You WILL play the Sacred Shuffle. But, who will profit from it? The Cult? You? Humanity?": "Vous JOUEREZ l'Arrangement Sacré. Mais qui en profitera ? Le Culte ? Vous ? L’humanité ?",
	"You?": "Vous ?",
	...
	"We hold one great advantage over the Cult. A card up our sleeve, in a manner of speaking!": "Nous détenons un grand avantage sur le Culte. Une carte dans notre manche, pour ainsi dire !",
	"Were you the Queen's official punster?": "Étiez-vous le faiseur de jeux de mots officiel de la Reine ?",
	"The Cult does not know that the Sacred Shuffle does not choose a screen. It chooses a player. They do not know you have been chosen. They cannot know. You have to keep playing and beat a shuffle on every floor.": "Le Culte ignore que l'Arrangement Sacré ne choisit pas un écran. Il choisit un joueur. Ils ignorent que vous avez été choisi. Ils ne peuvent pas le savoir. Vous devez continuer à jouer et vaincre un arrangement à chaque étage.",
	...
	"I don’t think The Cult of Doom brought any water bottles.": "Je ne crois pas que le Culte de la Perdition ait apporté des bouteilles d’eau.",
	"Oh, I wasn’t talking to you.": "Oh, je ne vous parlais pas à vous.",
	"Huh?": "Hein ?",
	"Never mind. Do you have any other questions? The other Time Patrons might not be as helpful as I.": "Peu importe. Avez-vous d’autres questions ? Les autres Mécènes Temporels ne seront peut-être pas aussi obligeants que moi.",
	"You keep mentioning other Time Patrons…": "Vous ne cessez de mentionner d’autres Mécènes Temporels…",
	...
	"A lot of them also fell from high, found hardship, exile, captivity, and in duress, almost touched the Sacred Shuffle.": "Beaucoup d’entre eux sont aussi tombés de haut, ont connu l’épreuve, l’exil, la captivité, et, à leur plus bas, ont presque touché l'Arrangement Sacré.",
	"What do you mean « almost »?": "Que voulez-vous dire par « presque » ?",
	"They got close to the Sacred Shuffle by helping you find it.": "Ils se sont approchés de l'Arrangement Sacré en vous aidant à le trouver.",
	"I’m confused.": "Je suis confus.",
	"Time paradoxes tend to do that.": "Les paradoxes temporels ont tendance à faire cet effet.",
	"You are.": "Vous.",
	"Through Solitaire, they will talk to you from their time period, as I am doing. Through you, they are connected to the Sacred Shuffle.": "À travers le Solitaire, ils vous parleront depuis leur époque, comme je le fais. À travers vous, ils sont reliés à l'Arrangement Sacré.",
	"Which I haven’t found yet.": "Que je n’ai pas encore trouvé.",
	"Our crude human senses can only perceive time as linear, but it is not. All of this has happened before…": "Nos sens humains grossiers ne perçoivent le temps que de façon linéaire, mais il ne l’est pas. Tout ceci s’est déjà produit…",
	"…all of this will happen again. How did I know that?": "…et tout ceci se produira de nouveau. Pourquoi je connais cette phrase ?",
	"Your memory is starting to leak through time. Even if you think this is the first time we’re having this conversation, it could be the millionth time.": "Votre mémoire commence à fuir à travers le temps. Même si vous croyez que c’est la première fois que nous avons cette conversation, ce pourrait être la millionième fois.",
	"That’s encouraging.": "C’est encourageant.",
	"You have to contact them.": "Vous devez les contacter.",
	"How?": "Comment ?",
	"You need to generate Time Energy, but also you need to weave the threads of time, find the connections between the Time Patrons. Even I do not know their all their identities. There is one from my time...": "Vous devez générer de l’Énergie Temporel, mais aussi tisser les fils du temps, trouver les connexions entre les Mécènes Temporels. Même moi, je ne connais pas toutes leurs identités. Il y en a une de mon époque…",
	"Who?": "Qui ?",
	"Mary Stuart, Queen of the Scots.": "Mary Stuart, reine des Écossais.",
	...
	"Go through the challenges of the Cult of Doom again, keep weaving the threads of the secret history of Solitaire and find the Sacred Shuffle!": "Traversez de nouveau les épreuves du Culte de la Perdition, continuez à tisser les fils de l’histoire secrète du Solitaire et trouvez l'Arrangement Sacré !",
	...
	"Another Solitaire game completed, and you’ve beaten your personal record at that!": "Encore une partie de Solitaire terminée, et vous avez battu votre record personnel en plus !",
	"As the screen suddenly flickers…": "Alors que l’écran clignote soudainement…",
	...
	"Eyes so dead, skin so pale, lips so dry.": "Des yeux si morts, des peaux si pâles, des lèvres si sèches.",
	...
	"Before you can even think of an answer, your screen flickers again.": "Avant même de songer à une réponse, votre écran clignote de nouveau.",
	...
	"You wonder if you’re more confused by the fact that it’s talking to you or by the fact that it somehow knows what you were thinking.": "Vous vous demandez ce qui vous trouble le plus : qu’il vous parle, ou qu’il sache étrangement ce que vous pensiez.",
	...
	"What the hell?": "C'est quoi cet enfer ?",
	...
	"Whoa.": "Ouah.",
	"There is one particular arrangement. The Sacred Shuffle. It does something extraordinary.": "Il existe un arrangement particulier. l'Arrangement Sacré. Il accomplit une chose extraordinaire.",
	"It gives dominion over time, way beyond the childish dark arts the Cult currently dabbles in, and way beyond the simple time projection I am using to contact you.": "Il donne l’empire sur le temps, bien au-delà des arts sombres puérils auxquels le Culte s’adonne pour l’instant, et bien au-delà de la simple projection temporelle que j’utilise pour vous contacter.",
	...
	"Great.": "Génial.",
	"We will talk more later. Now, you must play or the Cult will notice you and kill you!": "Nous reparlerons plus tard. Maintenant, vous devez jouer, sinon le Culte vous remarquera et vous tuera !",
